...
//   const apiUrl = 'https://api-singapore.bugraid.ai/api/v1';
//   let grafana;
//   let newRelic;
//   let pagerDuty;
//   let aws;
...
//     cy.request({
//       method: 'POST',
//       url: `${apiUrl}/integration/service-alerts/grafana/BHDSO4LJ/uaL2W8LU`,
//       headers: {
//         'Content-Type': 'application/json'
//       },
//       body: grafana
//     }).then((response) => {
//       expect(response.status).to.eq(200); // Expected status
...
//       cy.request({
//         method: 'POST',
//         url: `https://api-singapore.bugraid.ai/api/v1/integration/service-alerts/newrelic/BHDSO4LJ/Q65tI-ZX`,
//         headers: {
//             'Content-Type': 'application/json',
//         },
//         body: {
...
//         cy.request({
//             method: 'POST',
//             url: `https://api-singapore.bugraid.ai/api/v1/integration/service-alerts/pagerduty/BHDSO4LJ/psnnpYnI`,
//             headers: {
//                 'Content-Type': 'application/json',
//             },
//             body: {
...
//             expect(response.status).to.eq(200); // Check for a successful status code
//             // Optional: Validate that response contains any expected keys
//         });
//     });
...
//         cy.request({
//             method: 'POST',
//             url: `https://api-singapore.bugraid.ai/api/v1/integration/service-alerts/cloudwatch/BHDSO4LJ/GPWRBayg`,
//             headers: {
//                 'Content-Type': 'application/json',
//             },
//             body: {
...
describe('Integration API Tests', () => {
  ...
  it('Should integrate with Grafana successfully', () => {
    ...
    it('Should integrate with New Relic successfully', () => {
      cy.request({
        method: 'POST',
        url: `${apiUrl}/integration/service-alerts/newrelic/BHDSO4LJ/Q65tI-ZX`,
        headers: {
          'Content-Type': 'application/json'
        },
        body: {
    ...
    it('Should integrate with PagerDuty successfully', () => {
      cy.request({
        method: 'POST',
        url: `${apiUrl}/integration/service-alerts/pagerduty/BHDSO4LJ/psnnpYnI`,
        headers: {
          'Content-Type': 'application/json'
        },
        body: {
    ...
    it('Should integrate with AWS successfully', () => {
      cy.request({
        method: 'POST',
        url: `${apiUrl}/integration/service-alerts/cloudwatch/BHDSO4LJ/GPWRBayg`,
        headers: {
          'Content-Type': 'application/json'
        },
        body: {
